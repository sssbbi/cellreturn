		...
		<li>
			<div class="product-name">
				...
				<div class="btn-area mt">
					<a href="https://store.cellreturn.com/KR/shop/item.php?it_id=1600309111" target="_blank" class="btn-type-01">상세보기</a>
...
<div class="wrapper2">
	<div class="wow fadeInUp text_center">
		<div>
			<a href="#buyzone">
				<img src="../assets/images/product/bd2_img.jpeg" alt>
			</a>
		</div>
		...
		<div class="flag" style="margin-top:70px;">
			<ul class="size2">
				<li>
					<a href="https://store.cellreturn.com/KR/shop/item.php?it_id=1600309111" target="_blank">
