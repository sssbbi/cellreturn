    ...
    <div class="in-bx">
      ...
      <div class="util-area">
        <div class="lang-bx">
          ...
          <ul>
            <li><a class="on" href="../../KR/main/main.php">KOR</a></li>
            <li><a href="../../EN/main/main.php">ENG</a></li>
            <li><a href="../../CN/main/main.php">CHN</a></li>
            <li><a href="../../JP/main/main.php">JPN</a></li>
          </ul>
        </div>
        <a href="https://store.cellreturn.com/" target="_blank" class="store-btn" title="STORE"></a>
      </div>
...
<div class="gnb-mobile">
  ...
  <div class="m-util">
    ...
    <ul class="policy-menu">
      ...
      <li><a href="../career/recruiting.php">인재채용</a></li>
      <li><a href="https://store.cellreturn.com/KR/sub/support/one-to-one-inquiry.php" target="_blank">고객문의</a></li>
    </ul>
