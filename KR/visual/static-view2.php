<div class="pop-con archive-view">
	<div class="pop-content">
			...
			<div class="img-slider swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="../assets/images/visual/static_list_img2_1.jpg" alt="이미지 1장">
					</div>
					<div class="swiper-slide">
						<img src="../assets/images/visual/static_list_img2_2.jpg" alt="이미지 2장">
					</div>
				</div>
		...
		"KLPGA 임미소 프로가 추천하는 기대 그 이상의 홈케어"
		</div>
